...
?>
  ...
  <body>
    ...
    <div class="container-catalin">
      <ul class="triplezone-navigation-links">
        <li><a href="bans.php" id="bans-triplezone" style="<?php echo $raspuns_rounded; ?>"><i class="fas fa-ban"></i> Bans <span class="span-bans"><?php if(empty($data_bans[0])){echo "0";} else {echo $data_bans[0];} ?></span></a></li>
        <li><a href="mutes.php" id="mutes-triplezone" style="<?php echo $raspuns_rounded; ?>"><i class="fas fa-comment-slash"></i> Mutes <span class="span-bans"><?php if(empty($data_mutes[0])){echo "0";} else {echo $data_mutes[0];} ?></span></a></li>
        <li><a href="kicks.php" id="kicks-triplezone" style="<?php echo $raspuns_rounded; ?>"><i class="fas fa-feather"></i> Kicks <span class="span-bans"><?php if(empty($data_kicks[0])){echo "0";} else {echo $data_kicks[0];} ?></span></a></li>
        <li><a href="warnings.php" id="warns-triplezone" style="<?php echo $raspuns_rounded; ?>"><i class="fas fa-exclamation-circle"></i> Avisos <span class="span-bans"><?php if(empty($data_warnings[0])){echo "0";} else {echo $data_warnings[0];} ?></span></a></li>
      </ul>
      <div class="anunt-catalin">
        <div class="header-anunt">
          <ul class="informations">
            <li><h3>Bem-vindo(a) a página de punições</h3></li>
            <li><p>Veja todos os bans, mutes, kicks e avisos dados no servidor!</p></li>
          </ul>
        </div>
        <div class="anunt-scris">
          <h3>Por que eu fui punido?</h3>
          <p>Se você foi punido, tanto mutado quanto banido, é porque você quebrou uma das regras do servidor. Temos diversas regras do servidor que foram feitas para manter a ordem e diversão. Se você ainda não entende o motivo da punição, entre em nosso discord e tire suas dúvidas.</p>
        </div>
        <div class="footer-anunt">
          <a href="https://discord.gg/Kmy8UdR"><i class="fas fa-book"></i> Apelar Baninmento</a>
        </div>
      </div>
    </div>
</div>
