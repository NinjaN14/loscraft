  ...
  <div class="container">
      <div class="server-list-container">
        <div class="server-list-header">
          <p>Bem-vindo(a) ao nosso novo site!</p>
        </div>
        <div class="server-list-corp">
          <div class="server-list-dreapta">
            <div class="server-list-dreapta-block">
              <p>Estamos lançando esse novo site com intuito de ajudar cada vez mais os jogadores do LoSCraft. Por enquanto, nosso site terá: <br>
              </p>
              <ul>
                <li><i class="fas fa-arrow-right"></i> Posts com atualizações e novidades. </li>
                <li><i class="fas fa-arrow-right"></i> Tutoriais; Links de votos, facilitando a vida na hora de votar em todos os links. </li> 
                <li><i class="fas fa-arrow-right"></i> Nossa Equipe, para saberem quem está por trás do servidor. </li> 
                <li><i class="fas fa-arrow-right"></i> Ranking, listas com os melhores jogadores/clans em cada posição como: PvP, Construção, etc. </li> 
                <li><i class="fas fa-arrow-right"></i> Punições, listas com as punições realizadas no servidor. </li>
              </ul>
              <p></p>
            </div>
          </div>
