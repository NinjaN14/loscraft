  ...
  <div class="container">
      <div class="server-list-container">
        <div class="server-list-header">
          <p>O natal chegou no LoSCraft!</p>
        </div>
        <div class="server-list-corp">
          <div class="server-list-dreapta">
            <div class="server-list-dreapta-block">
              <p>Com a chegada do mês de dezembro diversas novidades ja foram implementadas no servidor mas vamos libera-las nos próximos dias então fiquem ligados. Agora vamos para as novidades..</p>
            </div>
